...
public class IntegrationTest {
    ...
    private void assertDB1(Connection connection) throws SQLException {
        ...
        /* n.b. We can't use assertTrue, assertFalse, getInt, getFloat, or
         * getBoolean here because they don't handle null values
         * correctly. */
        ...
        assertNull((Float)rs.getObject("FP_DAYS_SINCE_LMP"));
    ...
    /* FIXME: Add a test with risk factors. */
}
